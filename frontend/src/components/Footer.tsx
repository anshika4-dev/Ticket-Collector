      ...
      <div className="container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: '13px' }}>
          ...
          <a
            ...
            style={{ color: 'var(--accent-purple)', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: 4 }}
          >
            Anshika{' '}
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="14" width="14" xmlns="http://www.w3.org/2000/svg" style={{ display: 'inline', verticalAlign: 'middle' }}>
        ...
        <p style={{ fontSize: '12px', color: 'var(--text-muted)', marginTop: 4 }}>
          © 2026 TicketCollector. All rights reserved.
        </p>
      </div>
    </footer>
  );
